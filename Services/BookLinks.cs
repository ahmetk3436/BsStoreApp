...
namespace Services
{
    public class BookLinks : IBookLinks
    {
        ...
        private readonly IDataSharper<BookDto> _dataSharper;
        public BookLinks(LinkGenerator linkGenerator, IDataSharper<BookDto> dataSharper)
        {
