...
namespace Services
{
    public class DataSharper<T> : IDataSharper<T>
    {
        ...
        public IEnumerable<ShapedEntity> SharperData(IEnumerable<T> entities, string fieldsString)
        {
            var requiredFields = GetRequiredProperties(fieldsString);
            return FetchData(entities, requiredFields);
        }

        public ShapedEntity SharperData(T entity, string fieldsString)
        {
        ...
        private IEnumerable<ShapedEntity> FetchData(IEnumerable<T> entities,IEnumerable<PropertyInfo> requiredProperties)
        {
            ...
            { 
                ...
                shapedData.Add(objectPropertyValue);
